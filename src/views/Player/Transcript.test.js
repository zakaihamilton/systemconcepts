...
describe('Transcript Component', () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks();
    useTranslations.mockReturnValue({ MATCHES: '{current} of {total}', CLOSE: 'Close', DOWNLOAD_TRANSCRIPT: 'Download' });
    mockPlayer = {
    ...
    PlayerStore.useState.mockReturnValue({ subtitles: 'test.vtt', transcriptionUrl: '', player: mockPlayer });
    useFetch.mockReturnValue(["WEBVTT\n\n00:00:01.000 --> 00:00:05.000\nHello World", false, false]);
