...
jest.mock("./ProgressDialog", () => () => <div data-testid="progress-dialog" />);
...
describe('Groups View', () => {
  beforeEach(() => {
    jest.clearAllMocks();
    useTranslations.mockReturnValue({ NAME: 'Name', PROGRESS: 'Progress', STORAGE: 'Storage', SIZE: 'Size', SESSIONS: 'Sessions', COLOR: 'Color' });
