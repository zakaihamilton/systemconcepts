...
export default function API() {
	...
	const sectionNavSlotRef = useRef<HTMLDivElement>(null);
	const sectionNavMeasureRef = useRef<any>(null);
	const [sectionNavFrame, setSectionNavFrame] = useState<any>(null);
	...
	useEffect(() => {
		...
		const updateSectionNav = () => {
			...
			setSectionNavFrame((previousFrame: any) => {
		...
		let transitionFrame: any = null;
		let resizeObserver = null;
		const trackLayoutTransition: any = () => {
...
if response.status_code == 200:
	...
	const handleSectionJump = (sectionId: any) => {
