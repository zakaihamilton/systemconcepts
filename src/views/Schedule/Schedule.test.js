...
import SchedulePage, { ScheduleStore } from './Schedule';
...
describe('Schedule View', () => {
  beforeEach(() => {
    ...
    useTranslations.mockReturnValue({ LOADING: 'Loading', YEAR_VIEW: 'Year', MONTH_VIEW: 'Month', WEEK_VIEW: 'Week', DAY_VIEW: 'Day', TRACKS_VIEW: 'Tracks', HISTORY_VIEW: 'History' });
