...
jest.mock("@ui/IconButton", () => ({ children, onClick, className }: any) => (
	<button type="button" className={className} onClick={onClick}>
		{children}
	</button>
));
jest.mock("@ui/Typography", () => ({ children, onClick, className }: any) => (
	<button type="button" className={className} onClick={onClick}>
		{children}
	</button>
));
...
jest.mock("@components/Virtualized/FixedSizeList", () => {
	...
	return React.forwardRef(function MockFixedSizeList(props: any, ref: any) {
		const {
			children: Child,
			itemData,
			itemCount,
