...
jest.mock("@widgets/Input", () => (props: any) => (
...
jest.mock("./DayHeader", () => ({ index }: any) => (
	<div data-testid={`day-header-${index}`} />
));
jest.mock("./Week", () => (props: any) => (
...
describe("MonthView", () => {
	...
	it("swipes popup days and disables root swipe while popup is open", () => {
		...
		fireEvent.click(screen.getByTestId("open-day-2"));
		const openDate: any = sessionsProps.date.getTime();
