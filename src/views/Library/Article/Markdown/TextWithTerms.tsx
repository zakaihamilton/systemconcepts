...
export function extendTermEndForParenthetical(
	text: any,
	end: any,
	term: any,
	glossaryEntry: any,
	...
	if (hasConfirmingGlossaryParenthetical(text, end, term, glossaryEntry)) {
		...
		return end + (parentheticalMatch?.[0].length || 0);
	}
	return end;
}

export function collectGlossarySpans(text: any) {
	const spans = [];
...
export function Highlight({ search, children }: any) {
...
export function TextWithTerms({ text }: any) {
