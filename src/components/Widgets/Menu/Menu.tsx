...
export default function MenuWidget({
	...
	const [anchorElInternal, setAnchorElInternal] = useState<any>(null);
	...
	const [_hoverRef, setHoverRef] = useState<any>(null);
	...
	const checkListFeatures = (list: any) => {
	...
	const renderItems = (itemsList: any) => {
		...
		return (itemsList || []).flatMap((item: any, index: any, list: any) => {
