...
function isStoragePath(path: any) {
	return (
		typeof path === "string" &&
...
function isLegacyImageUrl(path: any) {
...
export default function ImageWidget({
	...
	const loadingAttribute =
		loading === "eager" || loading === "lazy" ? loading : undefined;
	...
	return (
		<Link
			...
			color="initial"
			style={buttonStyle}
			className={clsx(styles.root, className, clickable && styles.clickable)}
			disabled={!hasPath || !!error}
