...
export default React.memo(function TableWidget(props: any) {
	let {
		name,
		rowHeight = "4em",
		itemHeight = "4em",
	...
	useEffect(() => {
		return () => {
			tableDataRegistry.delete(registryId);
		};
	}, [registryId]);
	...
	const height =
		size.height - (statusBarIsActive ? sizeToPixels(statusBarHeight) : 0);
	const style = {
