...
// Optimization: Use React.memo to prevent unnecessary re-renders of rows.
// This is critical when parent TableWidget re-renders (e.g. scroll state updates),
// ensuring only rows with changed props need to re-render.
// Logic mirrors Item.js optimization.
export default memo(RowWidget, (prev, next) => {
