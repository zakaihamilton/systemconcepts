...
export function Tabs({ children, value, onChange, className, ...props }: any) {
	const rootRef = useRef<HTMLDivElement>(null);
	const [indicatorStyle, setIndicatorStyle] = useState<any>(null);
	...
	useLayoutEffect(() => {
		...
		const scheduleIndicatorUpdate: any = () => {
