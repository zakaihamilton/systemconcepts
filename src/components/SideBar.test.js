...
jest.mock("./SideBar/QuickAccess", () => () => <div data-testid="quick-access" />);
jest.mock("./SideBar/LibraryTree", () => () => <div data-testid="library-tree" />);
jest.mock("@views/ResearchIndexer/ResearchIndexer", () => () => <div data-testid="research-indexer" />);
...
describe('SideBar Component', () => {
  beforeEach(() => {
    ...
    MainStore.useState.mockReturnValue({ direction: 'ltr', showSlider: false, hash: '', libraryExpanded: false });
  ...
  it('renders drawer on mobile', () => {
    ...
    MainStore.useState.mockReturnValue({ direction: 'ltr', showSlider: true, hash: '', libraryExpanded: false });
