 ...
 */
export function compressJSON(data: any) {
 ...
 */
export function decompressJSON(buffer: any) {
 ...
 */
export async function readCompressedFileRaw(
	path: any,
...
export async function writeCompressedFile(
	path: any,
	data: any,
	folderCache: Set<string> | null = null,
) {
	path = makePath(path);
	try {
