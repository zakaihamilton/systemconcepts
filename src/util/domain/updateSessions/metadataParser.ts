export function getZipTextEntryId(relativePath: any) {
...
export function parseSessionMetadataJSON(content: any, property: any) {
...
export function parseSummariesMarkdown(content: any) {
