...
export function mixColors(color1: any, color2: any, weight: any) {
...
export function useSessionTextColor(sessionColor: any) {
...
export function getSessionTextColor(sessionColor: any, theme?: any) {
