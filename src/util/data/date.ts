export function getMonthViewStart(date: any) {
	date = new Date(date);
...
export function getMonthViewEnd(date: any) {
	date = new Date(date);
...
export function getWeekViewStart(date: any) {
	date = new Date(date);
	const day = date.getDay();
	const diff = date.getDate() - day;
	date.setDate(diff);
...
export function getWeekViewEnd(date: any) {
...
export function addDate(date: any, index: any) {
	date = new Date(date);
...
export function isDayToday(date: any) {
	const today = new Date();
	return (
...
export function isDateMonth(date: any, month: any) {
	return (
...
export function diffDays(from: any, to: any) {
...
export function setWeekOfMonth(date: any, weekNum: any) {
	const weekOfMonth = getWeekOfMonth(date);
	const offset = date.getDate() + (weekNum - weekOfMonth) * 7;
	date.setDate(offset);
}

export function getNumberOfWeeksInMonth(date: any) {
...
export function getMonthNames(date: any, formatter: any) {
	date = new Date(date);
...
export function getYearNames(date: any, formatter: any, start: any, end: any) {
	date = new Date(date);
