...
const responseCache = new Map<any, any>();
let reloginRedirectStarted = false;

export function requireRelogin(response: any) {
...
function getCacheKey(url: any, options: Record<string, any> = {}) {
...
function getCachedResponse(cacheKey: any) {
...
function setCachedResponse(cacheKey: any, value: any, ttl: any) {
...
function extractCacheOptions(options: any) {
...
export function fetchBlob(url: any, options: any = {}) {
...
export function fetchText(url: any, options: any = {}) {
	options = Object.assign({}, options);
...
export function fetchJSON(url: any, options: any = {}) {
	options = Object.assign({}, options);
	options.headers = Object.assign(
		{},
			...
			.then((response) => {
				...
				response
					...
					.then(function (data) {
						...
						if (cacheKey) setCachedResponse(cacheKey, parsedData, cacheTtl);
						resolve(parsedData);
					})
					.catch((err) => {
						structuredLogger.debug("Fetch parse error :", err);
