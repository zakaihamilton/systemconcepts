...
export function getEmValueFromElement(element: any) {
	if (element && element.parentNode) {
		var parentFontSize = parseFloat(
...
export function useResize(depends: unknown[] = []) {
