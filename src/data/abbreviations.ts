export const abbreviations: Record<string, any> = {
	KHB: {
		eng: "Keter, Hochma, Bina",
		heb: "כתר, חכמה, בינה",
	},
	HGT: {
	...
	KHBT: {
		eng: "Keter, Hochma, Bina, Tifferet",
		heb: "כתר, חכמה, בינה, תפארת",
	},
	DHGT: {
	...
	TNHYM: {
		eng: "Tifferet, Netzah, Hod, Yesod, Malchut",
		heb: "תפארת, נצח, הוד, יסוד, מלכות",
	},
	KHBD: {
